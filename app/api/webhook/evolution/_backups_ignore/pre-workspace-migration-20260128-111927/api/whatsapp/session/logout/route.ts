...
import { findUserTenant, updateTenant } from "@/lib/tenant-context";
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Atualizar tenant também (se aplicável)
    ...
    if (tenant) {
      ...
      await updateTenant(tenant.id, { evolution_instances: updatedInstances });
    }
