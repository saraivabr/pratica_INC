-- =============================================================================
-- Migration: 021_sistema_intermediacao.sql
-- Descrição: Sistema completo de intermediação de vendas e comissões
-- Data: 28 Jan 2026
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS im_beneficiarios (
  ...
  CONSTRAINT im_beneficiarios_cpf_unique UNIQUE (tenant_id, cpf)
);
...
COMMENT ON TABLE im_vendas IS 'Registro de vendas imobiliárias';
COMMENT ON TABLE im_beneficiarios IS 'Corretores e equipe que recebem comissões';
