-- ================================================
-- MIGRATION 002: Melhorias do Sistema Clawd
-- Data: 28/01/2026
...
-- Exemplo de notificação de boas-vindas para todos os corretores
-- INSERT INTO notificacoes (corretor_id, tipo, mensagem, link_acao)
-- SELECT 
--   id,
--   'sistema',
--   'Sistema de notificações ativado! Você receberá alertas sobre leads importantes.',
--   '/corretor/dashboard'
-- FROM users
-- WHERE role = 'corretor';
...
COMMENT ON SCHEMA public IS 'Schema principal do AppNovo Pratica - Melhorias Clawd aplicadas em 28/01/2026';
