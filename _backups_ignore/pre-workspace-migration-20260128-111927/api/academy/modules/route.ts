...
export async function GET(request: NextRequest) {
    try {
        ...
        // Construir query
        let whereClause = 'WHERE m.tenant_id = $1 AND m.ativo = true';
...
export async function POST(request: NextRequest) {
    try {
        ...
        const query = `
            INSERT INTO academy_modules (tenant_id, categoria_id, slug, nome, descricao, imagem_url, duracao_minutos, ordem)
