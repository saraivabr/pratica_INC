...
export async function GET(request: Request, { params }: RouteParams) {
  try {
    ...
    const config = await getAgentConfig(tenantId, instanceName);
...
export async function PUT(request: Request, { params }: RouteParams) {
  try {
    ...
    const config = await upsertAgentConfig(tenantId, configInput, userId);
...
export async function DELETE(request: Request, { params }: RouteParams) {
  try {
    ...
    const deleted = await deleteAgentConfig(tenantId, instanceName);
