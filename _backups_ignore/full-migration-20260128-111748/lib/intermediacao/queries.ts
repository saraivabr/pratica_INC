...
GROUP BY
  ...
  v.status, v.descricao, v.tenant_id, v.criado_por, v.created_at, v.updated_at
`;
...
GROUP BY
  ...
  b.chave_pix, b.ativo, b.tenant_id, b.created_at, b.updated_at
`;
...
WHERE tenant_id = $1 AND documento = $2
LIMIT 1
`;
